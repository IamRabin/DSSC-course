...
Defines an iterator class which implements operator* and operator++, having
begin() and end() return the proper values.
...
{
    PUSH_BACK, // Adds entry to the end of a list
    PUSH_FRONT // Adds entry to the front of a list
};
...
private:
    ...
    void push_front(const T& v){
        head.reset(new Node{v, head.release()}); //to reset the head release memory
    }
